...
<section class="section" id="console" data-autoscroll>
  <div class="section-title">
    <h2>Interactive Console</h2>
    <span style="font-size:0.78rem;color:var(--dim);">optional — type <code>help</code> · or scroll up for the menu</span>
  </div>
